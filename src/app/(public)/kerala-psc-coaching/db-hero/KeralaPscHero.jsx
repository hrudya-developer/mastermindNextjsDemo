...
const stats = [
  ...
  },
  {
    icon: GraduationCap,
    value: "Your",
    label: "Success Our Mission",
  },
];

export default function KeralaPscHero() {
  return (
    <section
      className="
        relative
    ...
    >
      ...
      >
        <Image
          src="/assets/kerala-psc-coaching.webp"
          alt=""
          fill
          priority
          sizes="100vw"
      ...
      {/* =====================================================
          ...
          IMPORTANT:
          - overlay itself is full width
          - dark color only occupies left ~45%
          - smoothly fades out before right image
      ...
      {/* =====================================================
          MOBILE OVERLAY
          Stronger because text sits over full image
      ====================================================== */}
      <div
        aria-hidden="true"
        className="
